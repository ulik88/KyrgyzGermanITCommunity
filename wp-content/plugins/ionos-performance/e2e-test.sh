...
# Download tests of the feature plugins
docker exec -i playwright-wordpress bash -c "mkdir -p /tmp/performance/tests"
docker exec -i playwright-wordpress bash -c "cp /var/www/html/wp-content/plugins/ionos-performance/package.json /tmp/performance/package.json"
docker exec -i playwright-wordpress bash -c "cp /var/www/html/wp-content/plugins/ionos-performance/playwright.config.js /tmp/performance/playwright.config.js"
docker exec -i playwright-wordpress bash -c "cp /var/www/html/wp-content/plugins/ionos-performance/vendor/ionos/performance-feature-basic-settings/tests/basic-settings.test.js /tmp/performance/tests/basic-settings.test.js"
docker exec -i playwright-wordpress bash -c "mkdir -p /var/www/html/wp-content/plugins/ionos-performance/tests"
docker exec -i playwright-wordpress bash -c "cp /var/www/html/wp-content/plugins/ionos-performance/vendor/ionos/performance-feature-basic-settings/tests/htaccess-migrate-test-content.txt /var/www/html/wp-content/plugins/ionos-performance/tests/htaccess-migrate-test-content.txt"
docker exec -i playwright-wordpress bash -c "cp /var/www/html/wp-content/plugins/ionos-performance/vendor/ionos/performance-feature-caching/tests/caching-feature.test.js /tmp/performance/tests/caching-feature.test.js"

# run playwright test
docker exec -i playwright-wordpress bash -c "cd /tmp/performance && npm install"
docker exec -i playwright-wordpress bash -c "cd /tmp/performance && npx playwright test"
