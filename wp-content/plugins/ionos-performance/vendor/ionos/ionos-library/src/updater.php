...
class Updater {
	 ...
	 *
	 * @param object|bool $transient Value of the ‘update_plugins‘ transient. false if the value couldn‘t be retrieved.
	 *
	 * @return object|bool Transient value, modified if necessary.
	 */
